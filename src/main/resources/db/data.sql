...
values ('ssar', '$2a$10$FijxQcyFcb1kAid2tpXS2urJ8CrcjhSoPBCMMJsXQhMRPBrVLX3mO', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('cos', '$2a$10$FijxQcyFcb1kAid2tpXS2urJ8CrcjhSoPBCMMJsXQhMRPBrVLX3mO', 'cos@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('love', '$2a$10$FijxQcyFcb1kAid2tpXS2urJ8CrcjhSoPBCMMJsXQhMRPBrVLX3mO', 'love@nate.com', now());
